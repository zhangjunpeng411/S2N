...
#' @format bulk_ncR_cancer: A data frame object with 6 BRCA samples (columns) and 4794 ncRNAs (rows).
...
#' @format bulk_ncR_normal: A data frame object with 6 normal samples (columns) and 4929 ncRNAs (rows).
...
#' @format bulk_tar_cancer: A data frame object with 6 BRCA samples (columns) and 22427 target genes (rows).
#' @details The target gene expression data in breast cancer is obtained from TCGA (http://cancergenome.nih.gov/).
NULL
...
#' @format bulk_tar_normal: A dataframe object with 6 normal samples (columns) and 22427 target genes (rows).
#' @details The target gene expression data in normal breast is obtained from TCGA (http://cancergenome.nih.gov/).
NULL
...
#' @format scRNA_ncR_cancer: A data frame object with 736 barcodes of breast cancer cells (columns) and 147 lncRNAs (rows).
#' @details The lncRNA expression data in breast cancer cells is obtained from Wu et al.
#' The lncRNA expression data is regarded as single-cell ncRNA expression data in breast cancer.
#' @references Wu SZ, Al-Eryani G, Roden DL,  et al. A single-cell and spatially resolved atlas of human breast cancers. Nat Genet, 2021;53(9):1334-1347.
NULL
...
#' @format scRNA_ncR_normal: A data frame object with 2430 barcodes of normal breast cells (columns) and 343 lncRNAs (rows).
#' @details The lncRNA expression data in normal breast cells is obtained from GEO (GSE153889).
#' The lncRNA expression data is regarded as single-cell ncRNA expression data in normal breast.
...
#' @format scRNA_tar_cancer: A data frame object with 736 barcodes of CID3946 breast cancer cells (columns) and 9469 target genes (rows).
#' @details The target gene expression data in breast cancer cells is obtained from Wu et al.
...
#' @format scRNA_tar_normal: A data frame object with 2430 barcodes of normal breast cells (columns) and 11226 target genes (rows).
#' @details The target gene expression data in normal breast cells is obtained from GEO (GSE15388).
#' The target gene expression data is regarded as single-cell target gene expression data in normal breast.
...
#' @details The target gene count data is obtained from Wu et al.
#' The target gene expression data is regarded as single-cell target gene count data in breast cancer.
#' @references Wu SZ, Al-Eryani G, Roden DL, et al.  A single-cell and spatially resolved atlas of human breast cancers. Nat Genet, 2021;53(9):1334-1347.
NULL
...
#' @details The lncRNA count data is obtained from Wu et al.
#' The lncRNA expression data is regarded as single-cell ncRNA count data in breast cancer.
#' @references Wu SZ, Al-Eryani G, Roden DL, et al.  A single-cell and spatially resolved atlas of human breast cancers. Nat Genet, 2021;53(9):1334-1347.
NULL
...
#' @name mut_ncR
#' @aliases mut_ncR
#' @format mut_ncR: A character object with 158 mutation lncRNAs.
#' @details The mutation lncRNAs are collected from lncRNASNP v3.0 (http://gong_lab.hzau.edu.cn/lncRNASNP3/).
